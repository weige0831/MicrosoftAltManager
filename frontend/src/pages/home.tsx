        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-px overflow-hidden rounded-xl border border-border/40 bg-border/40 md:grid-cols-3">
            {[
              ...
              <AnimateInView key={f.num} className={`group bg-background p-7 transition-colors duration-300 hover:bg-muted/20 md:p-8 ${f.span}`}>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-12">
            {[
              ...
              <AnimateInView key={f.t} delay={i * 100} className="group flex flex-col items-center text-center">
