    ...
    >
      ...
      >
        <div
          ...
          className='bg-sidebar group-data-[variant=floating]:ring-sidebar-border flex size-full flex-col transition-[border-radius,box-shadow,ring] duration-200 ease-linear group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-md group-data-[variant=floating]:ring-1'
        >
          {children}
        </div>
      </div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'bg-background relative flex w-full flex-1 flex-col transition-[margin,border-radius,box-shadow,height] duration-200 ease-linear',
        'md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-md md:peer-data-[variant=inset]:ring-1 md:peer-data-[variant=inset]:ring-border/50 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2',
        className
      )}
      {...props}
    />
