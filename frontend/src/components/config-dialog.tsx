    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>调整外观、配色、字体与密度</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-2">
              ...
              {THEME_PRESETS.map((p) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "group relative flex items-center gap-2 rounded-lg border p-2 text-left transition-all hover:bg-accent",
          ...
          <Section title="字体">
            <SegmentRow
              ...
              onChange={(v) => setFont(v as ThemeFont)}
            />
          </Section>
          ...
          <Section title="圆角">
            <SegmentRow
              ...
              onChange={(v) => setRadius(v as ThemeRadius)}
            />
          </Section>
          ...
          <Section title="密度">
            <SegmentRow
              ...
              onChange={(v) => setScale(v as ThemeScale)}
            />
          </Section>
        </div>
